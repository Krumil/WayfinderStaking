...
export async function GET(request: Request) {
	...
	const oxaniumMedium = fetch(new URL("../../Oxanium-Medium.ttf", import.meta.url)).then(res => res.arrayBuffer());
		...
		(
			<div
				style={{
					...
					textAlign: "center",
					color: "white",
					backgroundImage: "url(https://wayfinder-staking.vercel.app/assets/bg.png)",
					backgroundSize: "100% 100%",
					backgroundPosition: "center"
				}}>
				<div
					style={{
						background: "linear-gradient(45deg, rgba(73,73,73,0.5) 0%, rgba(184, 182, 140, 0.5) 100%)",
						overflow: "hidden",
					...
					<div style={{ display: "flex", flexDirection: "column", fontSize: "2.5rem" }}>
						<p style={{ margin: "0", display: "flex", alignItems: "center" }}>
							There are currently
							<span style={{ color: "#F0EEB1", padding: "0 5px", fontSize: "3rem" }}>
								{formatNumberWithCommas(primeBalance)}
							</span>
							$PRIME
						</p>
						<p style={{ margin: "0 0 2rem 0", display: "flex", alignItems: "center" }}>
							staked ({formatNumberWithCommas(totalStakedValueInUSD)} $USD)
						</p>
						<p style={{ margin: "0", display: "flex", alignItems: "center" }}>
							This is about
							<span style={{ color: "#F0EEB1", padding: "0 8px", fontSize: "3rem" }}>
								{totalPercentageStaked.toFixed(2)}%
							</span>
							of the total
						</p>
						<p style={{ margin: "0", display: "flex", alignItems: "center" }}>circulating supply</p>
					</div>
					<div
						style={{
							fontSize: "1.5rem",
