	...
	return (
		<div
			className={cn(
				...
				"bg-gradient-to-b from-neutral-900 to-black fixed bottom-4 right-4 z-50",
				isExpanded
...
const FamilyButtonContainer: FC<FamilyButtonContainerProps> = ({ isExpanded, toggleExpand, children }) => {
	return (
		<motion.div
			className={cn(
